...
> ⛔ **SUPERSEDED（2026-07-18）**：本檔已由 [`PROJECT_PLAN_2026-07-18.md`](PROJECT_PLAN_2026-07-18.md) 取代，保留為歷史。取代原因：現況失真（v0.14.133→v0.14.221）＋新增 UI 質感／前端效能兩軸；戰略推薦由「主線 Phase B」調整為「前端健康化優先（Option A）」。本檔以下內容為 2026-07-05 當時狀態。
