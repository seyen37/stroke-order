...
![tests](https://img.shields.io/badge/tests-1817%20passed-brightgreen)
![python](https://img.shields.io/badge/python-3.10%20%7C%203.11%20%7C%203.12-blue)
![license](https://img.shields.io/badge/license-MIT-yellow)
![version](https://img.shields.io/badge/version-0.14.239-orange)
...
## 目前版本：見上方 version badge（單一事實源＝pyproject.toml，收工時自動同步）
...
├── tests/                             # 完整測試套件（數量見上方 tests badge）
