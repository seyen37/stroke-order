...
![tests](https://img.shields.io/badge/tests-1651%20passed-brightgreen)
![python](https://img.shields.io/badge/python-3.10%20%7C%203.11%20%7C%203.12-blue)
![license](https://img.shields.io/badge/license-MIT-yellow)
![version](https://img.shields.io/badge/version-0.14.164-orange)
...
## 目前版本：0.14.164 (Phase 1 → 5cx + Phase A 組件分析器 + zentangle 6z)
