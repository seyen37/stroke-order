...
![tests](https://img.shields.io/badge/tests-1601%20passed-brightgreen)
![python](https://img.shields.io/badge/python-3.10%20%7C%203.11%20%7C%203.12-blue)
![license](https://img.shields.io/badge/license-MIT-yellow)
![version](https://img.shields.io/badge/version-0.14.144-orange)
...
## 目前版本：0.14.144 (Phase 1 → 5cc + Phase A 組件分析器 + zentangle 6z)
